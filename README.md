...
Personal Home Assistant OS configuration for a 3-floor house. Address and location details are stored in `secrets.yaml` (gitignored). Runs on HAOS at `192.168.4.93`, remotely accessible via Nabu Casa.
